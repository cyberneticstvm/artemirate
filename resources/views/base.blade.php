...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Diva Creative - Minimal and Modern Multipurpose Bootstrap 5 Html Template</title>
        ...
        <div class="pageWrapper">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-4 d-none d-md-none d-lg-block">
                                    <div class="text-center">
                                        <p class="top-header_middle-text transform-none">Summer sale discount off 50%!</p>
                                    </div>
                                </div>
                        ...
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                ...
                                <div class="logo col-4 col-sm-4 col-md-2 col-lg-2 text-center">
                                    <a href="index.html"><img src="/images/logo-white.png" alt="Diva Multipurpose Html Template" title="Diva Multipurpose Html Template" /></a>
                                </div>
                                <!-- End Desktop Logo -->
                    ...
                    <div class="main-navigation d-none d-lg-block">
                        ...
                        <nav class="grid__item" id="AccessibleNav">
                            <ul id="siteNav" class="d-flex flex-wrap site-nav medium center m-auto hidearrow">
                                ...
                                <li class="lvl1 parent megamenu">
                                    ...
                                    <div class="megamenu style1">
                                        <div class="row">
                                            ...
                                            <div class="lvl-1 col-12 col-md-3 col-lg-3 product-menu">
                                                ...
                                                <div class="grid-products text-center">
                                                    <div class="product-image">
                                                        <a href="product-layout1.html" class="grid-view-item__link"><img src="/images/megamenu/megamenu-product_286x400.jpg" alt="image" title="" /></a>
                                                    </div>
                                            ...
                                            <div class="col-12 imageCol d-none">
                                                <div class="row mm2-banner">
                                                    <div class="col-12 col-md-6 col-lg-6">
                                                        <a href="shop-left-sidebar.html"><img src="/images/megamenu/megamenu-bg2_600x160.jpg" alt="image" /></a>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-6">
                                                        <a href="shop-listview-sidebar.html"><img src="/images/megamenu/megamenu-bg2_600x160.jpg" alt="image" /></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li class="lvl1 parent megamenu">
                                    ...
                                    <div class="megamenu style2">
                                        <ul class="row mmWrapper">
                                            ...
                                            <li class="lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1 menu-title">Top Brands</a>
                                                <div class="menu-brand-logo">
                                                    <a href="#"><img src="/images/logo/brandlogo1_200x100.jpg" alt="image"/></a>
                                                    <a href="#"><img src="/images/logo/brandlogo1_200x100.jpg" alt="image"/></a>
                                                    <a href="#"><img src="/images/logo/brandlogo1_200x100.jpg" alt="image"/></a>
                                                </div>
                                                <div class="menu-brand-logo">
                                ...
                                <li class="lvl1 parent megamenu">
                                    <a href="#">Collections <i class="an an-angle-down"></i></a>
                                    <div class="megamenu style2">
                                        <ul class="row mmWrapper">
                                            <li class="lvl-1 col-md-3 col-lg-3">
                                                <a href="#" class="site-nav lvl-1 menu-title">Clothing</a>
                                                <a href="shop-left-sidebar.html" class="catalogueImg mb-2"><img src="/images/megamenu/collection-1_300x300.jpg" alt="image" /></a>
                                                <ul class="subLinks">
                                                    <li class="lvl-2"><a href="#" class="site-nav">Tops &amp; Tees</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Dresses &amp; Jumpsuits</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Trousers &amp; Jeans</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Winter Jackets</a></li>
                                                </ul>
                                            </li>
                                            <li class="lvl-1 col-md-3 col-lg-3">
                                                <a href="#" class="site-nav lvl-1 menu-title">Bags</a>
                                                <a href="shop-left-sidebar.html" class="catalogueImg mb-2"><img src="/images/megamenu/collection-1_300x300.jpg" alt="image" /></a>
                                                <ul class="subLinks">
                                                    <li class="lvl-2"><a href="#" class="site-nav">Hobo Bags</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Satchel Bags</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Clutch Handbags</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Crossbody Bags</a></li>
                                                </ul>
                                            </li>
                                            <li class="lvl-1 col-md-3 col-lg-3">
                                                ...
                                                <a href="shop-left-sidebar.html" class="catalogueImg mb-2"><img src="/images/megamenu/collection-1_300x300.jpg" alt="image" /></a>
                                                <ul class="subLinks">
                                                    <li class="lvl-2"><a href="#" class="site-nav">Outdoor Shoes</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Costume Footwear</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Girl's Boots</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Rain Footwear</a></li>
                                                </ul>
                                            </li>
                                            <li class="lvl-1 col-md-3 col-lg-3">
                                                <a href="#" class="site-nav lvl-1 menu-title">Accessories</a>
                                                <a href="shop-left-sidebar.html" class="catalogueImg mb-2"><img src="/images/megamenu/collection-1_300x300.jpg" alt="image" /></a>
                                                <ul class="subLinks">
                                                    <li class="lvl-2"><a href="#" class="site-nav">Watches</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Bracelets</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Pedometers</a></li>
                                                    <li class="lvl-2"><a href="#" class="site-nav">Necklaces</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="megamenu style2">
                                        <ul class="row mmWrapper">
                                            ...
                                            <li class="col-12 imageCol">
                                                <a href="#"><img src="/images/megamenu/megamenu-bg4_1200x100.jpg" alt="image" /></a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
            ...
            <div class="mobile-nav-wrapper dark-wrapper" role="navigation">
                ...
                <ul id="MobileNav" class="mobile-nav">
                    ...
                    <li class="lvl1 parent megamenu">
                        <a href="#">Collections <i class="an an-plus"></i></a>
                        <ul>
                            <li>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-3 col-lg-3 custom-block">
                                    <div class="footer-logo"><img src="/images/logo-white.png" alt="Diva Multipurpose Html Template" title="Diva Multipurpose Html Template" width="130" /></div>
                    ...
                    <div class="footer-bottom">
                        <div class="container">
                            <div class="row flex-row-reverse">
                                ...
                                <!-- End Footer Menu -->
                                <!-- Footer Copyright -->
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 copyright d-flex justify-content-center justify-content-md-start align-items-center"><span>&copy; 2021 DIVA.</span> All Rights Reserved.</div>
                        ...
                        <div class="minicart-body">
                            ...
                            <div id="drawer-minicart" class="block block-cart">
                                <ul class="mini-products-list">
                                    <li class="item">
                                        <a class="product-image" href="cart.html"><img src="/images/product-images/minicart_250x350.jpg" alt="Frayed Layered Sleeve" title=""></a>
                                    ...
                                    <li class="item">
                                        <a class="product-image" href="cart.html"><img src="/images/product-images/minicart_250x350.jpg" alt="Floral Lined Jacket" title=""></a>
                                        <div class="product-details">
                                            <a href="#" class="remove" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove"><i class="an an-times" aria-hidden="true"></i></a>
                                            <a href="#" class="edit-i remove" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="an an-edit" aria-hidden="true"></i></a>
                                    ...
                                    <li class="item">
                                        <a class="product-image" href="cart.html"><img src="/images/product-images/minicart_250x350.jpg" alt="Fit & Flare Trim Dress" title=""></a>
                                        <div class="product-details">
                                            <a href="#" class="remove" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove"><i class="an an-times" aria-hidden="true"></i></a>
                                            <a href="#" class="edit-i remove" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="an an-edit" aria-hidden="true"></i></a>
            ...
            <div id="open-addtocart-popup" class="addtocart-popup magnific-popup mfp-hide">
                <div class="addtocart-inner text-center clearfix">
                    ...
                    <div class="pro-img">
                        <img class="img-fluid blur-up lazyload" src="/images/product-images/addtocart-popup_200x250.jpg" data-src="/images/product-images/addtocart-popup_200x250.jpg" alt="image" title="image" />
                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="quickview-details mb-3 mb-md-0">
                                    ...
                                    <div class="quickview-details-img quickview-thumbnails-single">
                                        <div class="item">
                                            <img src="/images/product-images/product-large_1000x1400.jpg" data-src="/images/product-images/product-large_1000x1400.jpg" alt="image" />
                                        </div>
                                        <div class="item">
                                            <img src="/images/product-images/product-large_1000x1400.jpg" data-src="/images/product-images/product-large_1000x1400.jpg" alt="image" />
                                        </div>
                                    ...
                                    <div class="product-thumb-lists quickview-thumbnail-items">
                                        <div class="item">
                                            <img class="blur-up lazyload" src="/images/product-images/product-thumb_100x125.jpg" data-src="/images/product-images/product-thumb_100x125.jpg" alt="image" />
                                        </div>
                                        <div class="item">
                                            <img class="blur-up lazyload" src="/images/product-images/product-thumb_100x125.jpg" data-src="/images/product-images/product-thumb_100x125.jpg" alt="image" />
                                        </div>
                                        ...
                                        <div class="swatch clearfix swatch-1 option2" data-option-index="1">
                                            <div class="product-form__item">
                                                ...
                                                <div data-value="Red" class="swatch-element color red available" data-bs-toggle="tooltip" data-bs-placement="top" title="Red">
                                                    ...
                                                    <label class="swatchLbl color medium" for="swatch-0-red" style="background-image:url('/images/product-images/variant1_200x200.jpg');"></label>
                                                </div>
                                                <div data-value="Blue" class="swatch-element color blue available" data-bs-toggle="tooltip" data-bs-placement="top" title="Blue">
                                                    ...
                                                    <label class="swatchLbl color medium" for="swatch-0-blue" style="background-image:url('/images/product-images/variant1_200x200.jpg');"></label>
                                                </div>
                                                <div data-value="Green" class="swatch-element color green available" data-bs-toggle="tooltip" data-bs-placement="top" title="Green">
                                                    ...
                                                    <label class="swatchLbl color medium" for="swatch-0-green" style="background-image:url('/images/product-images/variant1_200x200.jpg');"></label>
                                                </div>
                                                <div data-value="Gray" class="swatch-element color gray available" data-bs-toggle="tooltip" data-bs-placement="top" title="Gray">
                                                    ...
                                                    <label class="swatchLbl color medium" for="swatch-0-gray" style="background-image:url('/images/product-images/variant1_200x200.jpg');"></label>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Product Action -->
